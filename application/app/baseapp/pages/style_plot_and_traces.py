...
def create_layout(limits_in):
    ...
    [
        dbc.Row(
            [
                dbc.Col(html.Div("1st of two columns"), width = 12), ## className="col-sm-12 col-md-6 col-lg-6"),
                dbc.Col(html.Div("2nd of two columns"),  width = 12), ##className="col-sm-12 col-md-6 col-lg-6")
