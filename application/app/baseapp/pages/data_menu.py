...
button_row = html.Div(
    [
        dbc.Row(
            [
                dbc.Col(html.Button('New', id=page_name + '_new_' + 'button_id', n_clicks=0, className="btn w-100 btn-primary btn-default", style={'margin-top':'10px'}), xs=6, sm=6, md=6, lg=3, xl=3, xxl=3),
                dbc.Col(html.Button('Edit', id=page_name + '_edit_' + 'button_id', n_clicks=0, className="btn w-100 btn-primary btn-default", style={'margin-top':'10px'}), xs=6, sm=6, md=6, lg=3, xl=3, xxl=3),
                dbc.Col(html.Button('List', id=page_name + '_list__' + 'button_id', n_clicks=0, className="btn w-100 btn-primary btn-default", style={'margin-top':'10px'}), xs=6, sm=6, md=6, lg=3, xl=3, xxl=3),
    ...
    ], style={'position': 'fixed','top': '54px', 'border': '3px solid green', 'width':'100%'}
)
