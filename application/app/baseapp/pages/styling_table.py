...
class StylingTable():
    ...
    def select_beginnings(self):
        ...
        cell_8 = html.Div("hello", style={'height':'12px', 'width':'50px', 'background-color':'blue'})
        ...
        table_row = html.Tr(className='tr', children=[cell_1,cell_2,cell_3,cell_8], style={'width':'100%','margin':'0','padding':'0','border':'1px solid black'})
