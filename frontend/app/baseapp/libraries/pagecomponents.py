...
page_header_1 =  dbc.Row(
            [
                dbc.Col(
                    ...
                    dcc.Link('Help', id='help_link_1', href='/app/baseapp/help',className="HEADER_TEXT"),
                    width=3,
                    className = "HEADER_COLUMN",
                ),
                dbc.Col(
                    #html.P("FAQ",className="HEADER_TEXT"),
                    dcc.Link('FAQ', id='faq_link_1', href='/app/baseapp/faq',className="HEADER_TEXT"),
                    width=3,
                    className = "HEADER_COLUMN",
                ),
                dbc.Col(
                    #html.P("Found A Bug", className="HEADER_TEXT"),
                    dcc.Link('Found A Bug', id='bug_link_1', href='/app/baseapp/bug',className="HEADER_TEXT"),
                    width=3,
                    className = "HEADER_COLUMN",
                ),
                dbc.Col(
                    #html.P("What's New", className="HEADER_TEXT"),
                    dcc.Link("What's New", id='whatsnew_link_1', href='/app/baseapp/whatsnew',className="HEADER_TEXT"),
                    width=3,
                    className = "HEADER_COLUMN",
                ),
            ],
...
page_header_2 = dbc.Row(
            [
                dbc.Col(
                    ...
                    dcc.Link('Plots', id='plots_link_1', href='/app/baseapp/list_user_plots',className="HEADER_TEXT"),
                    width=4,
                    className = "HEADER_COLUMN",
                ),
                dbc.Col(
                    #html.P("Data",  className="HEADER_TEXT"),
                    dcc.Link('home',id='data_link_1', href='/app/baseapp/list_all_limits',className="HEADER_TEXT"),
                    width=4,
                    className = "HEADER_COLUMN",
                ),
                 dbc.Col(
                    #html.P("Logged in as pauser (log out)", className="HEADER_TEXT"),
                    dcc.Link('Login',id='login_link_1', href='/app/baseapp/login',className="HEADER_TEXT"),
                    width=4,
                    className = "HEADER_COLUMN",
                 ),
            ],
