podman exec --user agaitske container_fastapi_about_1 alembic init -t async migrations
...
podman exec --user agaitske container_fastapi_about_1 alembic revision --autogenerate -m "Initial Commit"
